-- Make the trigger function SECURITY DEFINER and allow self-notifications
...
BEGIN
  ...
  IF v_instalacao_id IS NOT NULL THEN
    ...
    -- REMOVED: AND im.user_id != NEW.user_id; -- Allow self-notification for testing/single-user scenarios
  END IF;
