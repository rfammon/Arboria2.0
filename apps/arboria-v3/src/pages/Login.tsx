    ...
    return (
        <div className="h-[100dvh] w-full flex flex-col bg-background relative overflow-hidden">
            ...
            <div className="flex-1 w-full overflow-y-auto">
                <div className="flex min-h-full flex-col items-center justify-center p-6 relative z-10 animate-in fade-in zoom-in-95 duration-500">
                    <div className="w-full max-w-[400px] space-y-8">
                        <div className="text-center space-y-3">
                            ...
                            <h1 className="text-5xl font-black tracking-tighter text-[#0066CC] font-display">
