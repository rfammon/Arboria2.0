    ...
    return (
        <div className="space-y-4 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="tracking-tight font-display">Educação & <span className="text-primary italic">Treinamento</span></h1>
                    <p className="text-muted-foreground mt-1">Recursos e conteúdos para sua formação técnica em manejo florestal</p>
                </div>
                    ...
                    {topics.map((topic) => (
                        ...
                        >
                            ...
                            <CardHeader className="space-y-1 pb-2">
                                ...
                                <CardTitle className="tracking-tight">{topic.title}</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <CardDescription className="opacity-80 leading-relaxed">
                                    {topic.description}
                                </CardDescription>
