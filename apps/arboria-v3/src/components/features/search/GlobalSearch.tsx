    ...
    return (
        <>
            <button
                ...
                className="flex items-center gap-2 rounded-lg bg-muted/50 p-2 md:px-3 md:py-1.5 transition-all hover:bg-muted md:w-40 lg:w-64 border border-transparent hover:border-border"
            >
